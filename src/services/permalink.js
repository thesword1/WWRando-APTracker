...
class Permalink {
  static LOGIC_DIFFICULTY_OPTIONS = Constants.createFromArray(
    LOGIC_DIFFICULTY_OPTIONS,
  );

  static OPTIONS = Constants.createFromArray(OPTIONS);

  static MIX_ENTRANCES_OPTIONS = Constants.createFromArray(
    MIX_ENTRANCES_OPTIONS,
  );
  ...
  static #CONFIG = [
    ...
    this.#booleanConfig(this.OPTIONS.SMALL_KEYLUNACY),
    this.#booleanConfig(this.OPTIONS.BIG_KEYLUNACY),
