...
describe("Spheres", () => {
  describe("calculate", () => {
    ...
    const fullSetup = (settingsOverrides = {}) => {
      const defaultSettings = {
        ...
        startingGear: {
          ...
          [LogicHelper.ITEMS.WIND_WAKER]: 1,
          [LogicHelper.ITEMS.WINDS_REQUIEM]: 1,
        },
        flags: [
          Settings.FLAGS.BOSS,
    ...
    const updateForItemAndLocation = (
      itemName,
      generalLocation,
      detailedLocation,
    ) => {
    ...
    describe("when only having starting items", () => {
      ...
      test("only sets sphere to 0 for accessible locations", () => {
        ...
        expect(spheres.sphereForLocation("The Great Sea", "Cyclos")).toEqual(
          null,
        );
    ...
    describe("when finding an item in each sphere", () => {
      beforeEach(() => {
        ...
        updateForItemAndLocation(
          "Deku Leaf",
          "Pawprint Isle",
          "Chuchu Cave - Behind Left Boulder",
        );
      ...
      test("increases the sphere by 1 for each additional location", () => {
        ...
        expect(
          spheres.sphereForLocation(
            ...
            "Warp Maze Cave - First Chest",
          ),
        ).toEqual(3);

        expect(spheres.sphereForLocation("Bird's Peak Rock", "Cave")).toEqual(
          null,
        );
      });
    });
    ...
    describe("when charts are randomized", () => {
      ...
      test("tracks spheres for charts correctly after mapping", () => {
        trackerState = trackerState.setChartMapping(
          "Treasure Chart 30",
          "Star Island",
        );
